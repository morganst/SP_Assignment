    ...
    {!! Form::open(['action' => 'VolunteersController@store', 'method' => 'POST']) !!}
        <form>
            ...
            <div class="form-row">
                ...
                <div class="col col-md-3">
                    {!!  Form::select('status', ['Pending Approval' => 'Pending Approval', 'Inactive' => 'Inactive', 'Approved' => 'Approved', 'Disapproved' => 'Disapproved'],  'Pending Approval', ['class' => 'form-control' ]) !!}
                </div>
            </div>
            &nbsp;
            <div class="form-row">
                ...
                <div class="col col-md-3">
                    {!!  Form::select('location', ['Main Campus' => 'Main Campus', 'Animal Shelter' => 'Animal Shelter', 'Homeless Shelter' => 'Homeless Shelter', 'VA Office' => 'VA Office'], 'Main Campus', ['class' => 'form-control' ]) !!}
                </div>
            </div>
            &nbsp;
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="col col-md-3">
                    {!!  Form::select('education', ['Some High School' => 'Some High School', 'High School Grad' => 'High School Grad', 'Some College' => 'Some College', 'In College' => 'In College', 'College Grad' => 'College Grad', 'Grad Student' => 'Grad Student', 'Masters or Higher' => 'Masters or Higher'], 'Some High School', ['class' => 'form-control' ]) !!}
                </div>
            </div>
            &nbsp;
            <div class="form-row">
            ...
            {!! Form::label('copyLicense', 'Do we have a copy of license?', ['class' => 'col-lg-2 control-label'] )  !!}
                <div class="col col-md-3">
                    {!!  Form::select('copyLicense', ['0' => 'No', '1' => 'Yes'],  'No', ['class' => 'form-control' ]) !!}
                </div>
            </div>
            &nbsp;
            <div class="form-row">
            {!! Form::label('copySS', 'Do we have a copy of SS?', ['class' => 'col-lg-2 control-label'] )  !!}
                <div class="col col-md-3">
                    {!!  Form::select('copySS', ['0' => 'No', '1' => 'Yes'],  'No', ['class' => 'form-control' ]) !!}
                </div>
            </div>
            &nbsp;
            <div class="form-row">
                ...
                <div class="col col-md-5">
                    {{Form::textarea('skills', '', ['class' => 'form-control', 'rows' => 8, 'cols' => 5, 'placeholder' => 'Skills'])}}
                </div>
            </div>
